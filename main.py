...
def run_pipeline():
    ...
    """
    print('=' * 60)
    print("            3D VECTOR PIPELINE (TEST3)")
    print('=' * 60)
    ...
    try:
        # =================================================================
        # STEP 1: Create vector map with object heights (vmap.py)
        # =================================================================
        ...
        use_geographic = True  # Set to True if you want geographic coordinates
        ...
        # =================================================================
        # STEP 2: Update terrain elevation from DEM (dem.py)
        # =================================================================
        ...
        # =================================================================
        # STEP 3: Create 3D visualization (scene3D.py)
        # =================================================================
...
def main():
    ...
    Main entry point
    """
    print("🚀 Starting 3D Vector Pipeline (Test3)...")
